...
public class Invoices_02_AddEditInvoiceEntry extends AbstractTest {
	...
	public void setup(String browser, String ipClient, String port) {
		...
		log.info("Step Pre-condition - 07: Create new Job Code");
	...
	public void AddEditInvoiceEntry_001_CheckAddInvoiceEntryWorks() {	
		...
		log.info("Step AddEditInvoiceEntry_001 - 03: Click on Add button");
		poPage.clickOnImageButtonByItsSrc(DriverManager.getDriver(), "add.gif");
		
		log.info("Step AddEditInvoiceEntry_001 - 04: Input all selecter textfield");
		...
		log.info("Step AddEditInvoiceEntry_001 - 06: Input line item");
		...
		log.info("Step AddEditInvoiceEntry_001 - 08: Open Addl Header Info tab");
		poPage.openTab(DriverManager.getDriver(), "Addl Header Info");
		
		log.info("Step AddEditInvoiceEntry_001 - 09: Select all dropdowns");
		...
		log.info("Step AddEditInvoiceEntry_001 - 10: Input all selecter textfield");
		...
		log.info("Step AddEditInvoiceEntry_001 - 11: Input all textfields");
		...
		log.info("Step AddEditInvoiceEntry_001 - 12: Add Attachment");
		poPage.addAttachment("datatest1.pdf");
		
		log.info("Step AddEditInvoiceEntry_001 - 13: Click on Save button");
		poPage.clickOnImageButtonByItsSrc(DriverManager.getDriver(), "save.gif");
		poPage.sleep(3);
		
		log.info("Step AddEditInvoiceEntry_001 - VP: Input new Invoice Entry");
		poPage.inputTextfieldByID(DriverManager.getDriver(), "txt_VoucherNum", newVoucherNumber);
		
		log.info("Step AddEditInvoiceEntry_001 - VP: Click on Modify button");
		poPage.clickOnImageButtonByItsSrc(DriverManager.getDriver(), "manage");
		
		log.info("Step AddEditInvoiceEntry_001 - VP: Check fields are saved: all dropdowns");
		...
		log.info("Step AddEditInvoiceEntry_001 - VP: Check fields are saved: all selecter textfield");
		verifyTrue(poPage.isSuggestionDropdownDisplayedCorrectly(DriverManager.getDriver(), "div_Vendor", vendorName1));
		
		log.info("Step AddEditInvoiceEntry_001 - VP: Check fields are saved: all textfields");
		...
		log.info("Step AddEditInvoiceEntry_001 - VP: Check fields are saved: line item");
		...
		//Input for Addl Header Info tab
		log.info("Step AddEditInvoiceEntry_001 - 20: Open Addl Header Info tab");
		poPage.openTab(DriverManager.getDriver(), "Addl Header Info");
		...
		log.info("Step AddEditInvoiceEntry_001 - VP: Check fields are saved: Attachments tab");
	...
	public void AddEditInvoiceEntry_002_CheckEditInvoiceEntryWorks() {	
		...
		log.info("Step AddEditInvoiceEntry_002 - 12: Open Header / Line Info tab");
		poPage.openTab(DriverManager.getDriver(), "Header / Line Info");
		
		log.info("Step AddEditInvoiceEntry_002 - 13: Input all selecter textfield");
		poPage.inputSelecterTextfieldByID(DriverManager.getDriver(), "txt_Vendor", vendorName2);
		
		log.info("Step AddEditInvoiceEntry_002 - 14: Select all dropdowns");
		...
		log.info("Step AddEditInvoiceEntry_002 - 15: Input line item");
		...
		log.info("Step AddEditInvoiceEntry_002 - 16: Input all textfields");
		...
		//Input for Addl Header Info tab
		log.info("Step AddEditInvoiceEntry_002 - 17: Open Addl Header Info tab");
		poPage.openTab(DriverManager.getDriver(), "Addl Header Info");
		
		log.info("Step AddEditInvoiceEntry_002 - 18: Select all dropdowns");
		...
		log.info("Step AddEditInvoiceEntry_002 - 19: Input all selecter textfield");
		...
		log.info("Step AddEditInvoiceEntry_002 - 20: Input all textfields");
		...
		//Input for Attachments tab
		log.info("Step AddEditInvoiceEntry_002 - 21: Add Attachment");
		poPage.addAttachment("datatest2.pdf");
		
		log.info("Step AddEditInvoiceEntry_002 - 22: Click on Save button");
		poPage.clickOnImageButtonByItsSrc(DriverManager.getDriver(), "save.gif");
		poPage.sleep(3);
		
		log.info("Step AddEditInvoiceEntry_002 - 23: Input new Invoice Entry");
		poPage.inputTextfieldByID(DriverManager.getDriver(), "txt_VoucherNum", newVoucherNumber);
		
		log.info("Step AddEditInvoiceEntry_002 - 24: Click on Modify button");
		poPage.clickOnImageButtonByItsSrc(DriverManager.getDriver(), "manage");
		
		log.info("Step AddEditInvoiceEntry_002 - VP: Check fields are saved: all dropdowns");
		...
		log.info("Step AddEditInvoiceEntry_002 - VP: Check fields are saved: all selecter textfield");
		verifyTrue(poPage.isSuggestionDropdownDisplayedCorrectly(DriverManager.getDriver(), "div_Vendor", vendorName2));
		
		log.info("Step AddEditInvoiceEntry_002 - VP: Check fields are saved: all textfields");
		...
		log.info("Step AddEditInvoiceEntry_002 - VP: Check fields are saved: line item");
		...
		//Input for Addl Header Info tab
		log.info("Step AddEditInvoiceEntry_002 - VP: Open Addl Header Info tab");
		poPage.openTab(DriverManager.getDriver(), "Addl Header Info");
		...
		//Check for Attachments tab
		log.info("Step AddEditInvoiceEntry_002 - VP: Check fields are saved: Attachments tab");
